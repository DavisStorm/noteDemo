...
import com.davis.mall.animation.AlphaInAnimation;
import com.davis.mall.animation.BaseAnimation;
import com.davis.mall.animation.ScaleInAnimation;
import com.davis.mall.animation.SlideInBottomAnimation;
import com.davis.mall.animation.SlideInLeftAnimation;
import com.davis.mall.animation.SlideInRightAnimation;
import com.davis.mall.listener.OnItemDragListener;
import com.davis.mall.listener.OnItemSwipeListener;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int positions) {
        ...
        switch (viewType) {
            case 0:
                ...
                break;
            case LOADING_VIEW:
                Log.e(TAG, "LOADING_VIEW");
                addLoadMore(holder);
                break;
            case HEADER_VIEW:
                Log.e(TAG, "HEADER_VIEW");
                break;
            case EMPTY_VIEW:
                Log.e(TAG, "EMPTY_VIEW");
                break;
            case FOOTER_VIEW:
                Log.e(TAG, "FOOTER_VIEW");
                break;
            default:
                Log.e(TAG, "default");
                convert((BaseViewHolder) holder, mData.get(holder.getLayoutPosition() - getHeaderViewsCount()));
