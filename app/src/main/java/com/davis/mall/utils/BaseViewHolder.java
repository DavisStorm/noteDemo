...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    /**
     * Will set the NoDealWithInfoBean of a TextView.
     *
     * @param viewId The view id.
     * @param value  The NoDealWithInfoBean to put in the NoDealWithInfoBean view.
    ...
    /**
     * Will set NoDealWithInfoBean color of a TextView.
     *
     * @param viewId    The view id.
     * @param textColor The NoDealWithInfoBean color (not a resource id).
     * @return The BaseViewHolder for chaining.
     */
     ...
     * editextlistener
     */
    public BaseViewHolder addTextChangedListener(int viewId, TextWatcher textWatcher) {
        View view = getView(viewId);
