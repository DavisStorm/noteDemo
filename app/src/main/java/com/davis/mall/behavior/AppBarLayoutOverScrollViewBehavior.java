package com.davis.mall.behavior;
...
public class AppBarLayoutOverScrollViewBehavior extends AppBarLayout.Behavior {
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, AppBarLayout abl, int layoutDirection) {
        ...
        if (mTargetImageView == null) {
            String imageTag = MallApplication.getContext().getString(R.string.over_scroll_image);
        ...
        if (mTargetLabelView == null) {
            String labelTag = MallApplication.getContext().getString(R.string.over_scroll_label);
